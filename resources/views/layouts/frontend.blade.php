  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      <div class="humberger__menu__logo">
        <a href="#"><img src="{{ asset('frontend/img/logo.png') }}" alt="Logo" width="35" /></a>
      </div>
      ...
      <div class="humberger__menu__widget">
          ...
          <div class="header__top__right__language">
            ...
            <ul>
              <li><a href="/dashboard/admin">Profile</a></li>
            </ul>
          </div>
          <div class="header__top__right__auth" style="margin-left: 20px">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> Hallo sobat saget</li>
          <li>Penjemputan dan pengiriman gratis tersedia</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="header__logo">
              <a href="/"><img src="{{ asset('frontend/img/logo.png') }}" alt="" width="50"/></a>
            </div>
          </div>
          <div class="col-lg-6">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              <div class="footer__about__logo">
                <a href="./index.html"><img src="{{ asset('frontend/img/logo.png') }}" alt="" width="80"/></a>
              </div>
              <ul>
                <li>Address: Bandung</li>
                <li>Phone: +6211188888</li>
                <li>Email: hamzah@gmail.com</li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-12">
            <div class="footer__widget">
              <h6>Gabung ke perusahaan kita</h6>
              <p>
            ...
            <div class="footer__copyright">
              <div class="footer__copyright__text">
                <p>
                  ...
                  Saget | Toko buku online
                  <i class="fa fa-heart" aria-hidden="true"></i> by
                  <a href="https://colorlib.com" target="_blank">Saget</a>
                  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
              </div>
